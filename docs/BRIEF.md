...
- Interim email copy may use a polished designed template until final marketing copy is approved. SMS is one Latin GSM-7 segment: `TOON EXPO Toms:` (hy), `TOON EXPO Ticket:` (en), `TOON EXPO Bilet:` (ru).
