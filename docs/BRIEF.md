...
- Interim email copy may use a polished designed template until final marketing copy is approved. SMS is one segment: Latin `TOON EXPO ticket:` for Armenian and English, Russian `Билет:` when the 128-bit ticket link fits, otherwise Latin fallback.
