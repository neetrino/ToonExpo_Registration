...
- Interim email copy may use a polished designed template until final marketing copy is approved; SMS copy is one Latin GSM-7 segment (`TOON EXPO ticket:` plus the hosted-ticket link) for every locale.
