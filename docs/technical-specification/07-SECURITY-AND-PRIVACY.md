...
- Use a restrictive referrer policy and keep ticket routes out of analytics. GTM, Yandex Metrika and Meta Pixel load only on `[locale]` public routes, not `/ticket` or `/admin`.
