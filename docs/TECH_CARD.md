...
| Public analytics    | Vercel Analytics + GTM `GTM-NJZV2NL3` + Yandex Metrika `112495551` + Meta Pixel `1774204670579132` on `[locale]` routes only; `registration_complete` / `CompleteRegistration` on success | Client request 2026-09-16 |
